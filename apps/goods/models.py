...
class GoodsCategory(models.Model):
    ...
    parent_category = models.ForeignKey("self", null=True, blank=True, verbose_name='父类目类别', on_delete=models.CASCADE,
                                        help_text='父类目类别', related_name='sub_cat')
...
class GoodsCategoryBrand(models.Model):
    ...
    image = models.ImageField(upload_to="brands/", max_length=200, verbose_name='图片')
    add_time = models.DateTimeField(default=datetime.now, verbose_name='添加时间')
